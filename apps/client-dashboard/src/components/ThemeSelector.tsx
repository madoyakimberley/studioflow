                ...
                {THEMES.map((t) => {
                  ...
                  return (
                    <div
                      ...
                      className={`${t.id} group relative p-6 rounded-2xl cursor-pointer transition-all duration-300 ${
                        isActive
                    ...
                    >
                      ...
                      <div className="aspect-video w-full bg-theme-bg rounded-xl border border-theme-outline/30 mb-6 overflow-hidden relative shadow-inner p-4 flex gap-3 pointer-events-none transition-colors duration-300">
